...
from rules import Rule, Role, Predicate, OrExpression, TernaryExpression, ResponseAction
    ...
    def _parse_entity_definitions(domain_definition):
        ...
        for line in entity_definitions.split('\n'):
            ...
            if not entity_type:  # It comprised only whitespace
                ...
                raise Exception(error_message)
            # If we get to here, we have a valid entity definition. Construct an Entity object accordingly and
            # add it to our list of entities.
            entity_object = Entity(name=entity_name, entity_type=entity_type)
